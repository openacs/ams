...
foreach option_key [list new1 new2 new3] {
    ...
    if { [exists_and_not_null option_string] } {
        set option_id [ams::option::new -attribute_id $attribute_id -option $option_string]
...
ad_returnredirect -message "[_ ams.Options_Updated]" "attribute?[export_vars -url {attribute_id}]"
